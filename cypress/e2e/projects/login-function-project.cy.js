...
describe('Login Function Project',() => {
    ...
    it('Test Case 07 - Validate the invlaid login with the empty credentials', () => {
        // Leave username and password empty, then click on the "LOGIN" button
        cy.get('#login_btn').click()
        
        // Validate failure message is displayed with proper text
    ...
    it('Test Case 08 - Validate the invalid login with the wrong username', () => {
        // Enter the invalid username 'John'
        cy.get('#username').type('John')

        // Enter the valid password 'Test1234'
        cy.get('#password').type('Test1234')
    ...
    it('Test Case 09 - Validate the invalid login with the wrong password', () => {
        // Enter the valid username 'TechGlobal'
        cy.get('#username').type('TechGlobal')

        // Enter the invalid password '1234'
